<script>
import News from './componentsMenu/News.vue';
import LeftMenuAdminOptions from './componentsMenu/LeftMenuAdminOptions.vue';
import UserRequests from './componentsMenu/UserRequests.vue';
...
export default {
  ...
  methods: {
    ...
    captureVisibility(file){
        this.isRequestsBlockVisible = file['requestBlock'];
        this.isNewsBlockVisible = file['newsBlock'];
    }
  },
  components: {
    News,
    LeftMenuAdminOptions,
    UserRequests,
  }
};
</script>
<template>
    ...
    <LeftMenuAdminOptions @send-visibility="captureVisibility"/>
    
    <News :isVisible="isNewsBlockVisible"/>

    <UserRequests :isVisible="isRequestsBlockVisible"/>
