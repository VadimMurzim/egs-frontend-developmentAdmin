...
export default {
  data() {
    return {
      isRequestsBlockVisible: false,
      isProfileVisible: false,
      isNewsBlockVisible: false
    };
  },
  computed: {
    zayavki_count() {
  ...
  methods: {
    toggleRequestsBlock() {
      this.isRequestsBlockVisible = !this.isRequestsBlockVisible;
      this.isNewsBlockVisible = false;

      this.$emit('send-visibility', {
        requestBlock: this.isRequestsBlockVisible,
        newsBlock: this.isNewsBlockVisible
      });
    },
    toggleNewsBlock() {
        this.isNewsBlockVisible = !this.isNewsBlockVisible;
        this.isRequestsBlockVisible = false;
...
<template>
    <div class="left">
      <div class="menue">
        <div class="menue_nead">Меню</div>
        <ul class="menue_filling">
          <li class="menue_filling_li">
            <button
              class="menue_filling_li_text"
              @click="toggleRequestsBlock"
              :class="{ active: isRequestsBlockVisible }"
            >
              Заявки на регистрацию
            </button>
            <!-- <div class="menue_filling_li_notafivation">{{ zayavki_count }}</div> -->
          </li>
          <li class="menue_filling_li">
            <button
              class="menue_filling_li_text"
              @click="toggleNewsBlock"
              :class="{ active: isNewsBlockVisible }"
            >
              Редактор новостей
            </button>
          </li>
