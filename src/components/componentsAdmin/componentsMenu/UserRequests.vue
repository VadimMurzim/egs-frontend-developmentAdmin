...
export default {
      ...
      zayavki: [
        {
          ...
          nickname: 'nepridumal123',
          birthdate: '02.04.2005',
          gender: 'Мужской',
          phone: '+7 (921) 123–23–31',
          email: 'pochta3321@gmail.com',
          password: 'qwerty1234567890',
          region: 'Калининградская область',
          city: 'Калининград',
          status: 'Учусь',
          institution: 'ГБУ КО ПОО “Колледж информационных технологий и строительства”',
          steam: '(Ссылка)',
          faceit: '(Ссылка)',
          ...
          passport: 'Скачать первый разворот | Скачать второй разворот',
          photo: 'Скачать',
          certificate: 'Скачать',
        },
        {
  ...
  computed: {
    zayavki_count() {
      return this.zayavki.length;
    },
  },
  methods: {
    showProfile(id) {
      this.selectedProfile = this.zayavki.find((z) => z.id === id);
...
<template>
    <div v-show="isVisible" id="requestsBlock">
      <div class="Container_main_none">
        <div class="center">
          <div class="zayavki">
            <div class="zayavki_hedder">
              <div class="zayavki_hedder_text">Новые заявки</div>
              <!-- <div class="zayavki_hedder_notofication">{{ zayavki_count }} Количество заявок, пока просто убрал</div> -->
            </div>

            <div
              class="zayavki_filling"
              v-for="zayavka in zayavki"
              :key="zayavka.id"
            >
              <button class="zayavki_button" @click="showProfile(zayavka.id)">
                <div class="zayavki_button_text">
                  Пользователь: {{ zayavka.name }}
                </div>
                <div class="zayavki_button_img_container">
                  <div class="zayavki_button_img_text">Показать</div>
                  <!-- <img
                    src="../../fonts/Ctrelka.svg"
                    alt=""
                    class="zayavki_button_img"
                  /> -->
                </div>
              </button>
            </div>
        ...
        <div class="right" v-show="isProfileVisible" id="profileBlock">
          <div class="profile">
            <div class="profile_head">Данные пользователя</div>
            <div class="profile_content">
              <div
                class="profile_content_row"
                v-for="(value, key) in selectedProfile"
                :key="key"
              >
                <div class="profile_content_row_name">{{ key }}:</div>
                <div class="profile_content_row_data">{{ value }}</div>
              </div>
              <div class="profile_content_row">
                <a href="">
                  <button class="button">Разрешить</button>
                </a>
                <a href="">
                  <button class="button-register">Отклонить</button>
                </a>
              </div>
            </div>
          </div>
...
.zayavki_button_img_container{
    display: flex;
    margin-right: 20px; 
    /* Как бы должна быть стрелка вместо отступа, но изображение Стрелка в fonts пустое */
}
.center{
    margin-left: 20px;
}
