...
<template>
    <div class=" hidden news_input_img_cont" ref="hiddenBlock">
        <img src="../../../../../assets/img/site/news_img.png" alt="" class="news_input_img">
        <div class=" news_input_cont d-flex flex-column" >
            <div class=" news_input_cont_top d-flex justify-content-between align-items-center">
                <input type="text" class=" news_input_cont_top_input" placeholder="Заголовок" value="Стартует KINGDOM Season 4 Counter-Strike 2">
                <label for="date" class="news_input_cont_top_label d-flex">
                    <p class="news_input_cont_top_date"></p>
                    <input type="datetime-local" class=" news_input_cont_top_date" placeholder="Дата публикации" value="2024-03-10T10:30">
                </label>
            </div>
            <div class=" news_input_cont_bottom">
                <p class=" news_input_cont_bottom_p">Текст новости</p>
                <textarea class=" news_input_cont_bottom_textarea" placeholder="Текст" >Киберспорт - это мир виртуальных соревнований, где игроки демонстрируют свое мастерство в различных компьютерных играх. Этот вид спорта стремительно набирает популярность во всем мире, привлекая миллионы зрителей и участников.
В киберспорте игроки соревнуются в командных или индивидуальных дисциплинах, таких как Dota 2, Counter-Strike: Global Offensive, League of Legends, Overwatch и многих других. Игроки тренируются по многу часов в день, оттачивая свои навыки и стратегии, чтобы достичь высочайшего уровня мастерства.
Киберспортивные турниры проводятся по всему миру, собирая огромные аудитории как на стадионах, так и онлайн. Призовые фонды таких соревнований могут достигать десятков миллионов долларов, привлекая к участию профессиональные команды и игроков. Победители становятся настоящими звездами, получая признание и поклонение фанатов.</textarea>
            </div>
        </div>
    </div>
</template>
